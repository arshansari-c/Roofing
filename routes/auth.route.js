...
import { addTeamMemberEmail, fetchSelectedProjectData, fetchTeamEmails, fetchUploadProjectData, login,  Profile, register, sendPdfToTeamFromEmail, UpdateProfile, UploadProjectData } from '../controllers/auth.controller.js'
...
AuthRouter.post('/uploadproject/:userId',UploadProjectData)
