...
import { EditFreelancerDetails, fetchFreelancerList, FreelancerDetails } from '../controllers/freelancer.controller.js'
...
AuthRouter.get('/fetchfreelancerlist',CheckAuth,fetchFreelancerList)
AuthRouter.get('/fetchsupplierlist',CheckAuth,fetchSupplierList)
...
AuthRouter.get('/fetchorder',CheckAuth,fetchOrders)
